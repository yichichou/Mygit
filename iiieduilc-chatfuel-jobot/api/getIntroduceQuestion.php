...
$sql="SELECT Question FROM user_question  WHERE `FB_ID` = '$FB_ID' AND `Class`='Introduce' ORDER BY id DESC limit 1";
...
$sql = "INSERT INTO `fb_chatbot`(`Time`,`FB_ID`,`Gender`,`UserName`,`Phone`,`Email`,`FB_name`,`QuestionNo`,`Question`) VALUES ('$Time','$FB_ID','$Gender','$UserName','$Phone','$Email','$FB_name','$QuestionNo','$Question')";
$result = $conn->query($sql);
