...
UP1query<-paste("UPDATE `fb_chatbot_result` SET `no1`=",new_s[1], ", `no2`=",new_s[2],", `no3`=",new_s[3],", `no4`=",new_s[4], ", `no5`=",new_s[5],", `no6`=",new_s[6],", `no7`=",new_s[7],", `no8`=",new_s[8],", `no9`=",new_s[9],", `no10`=",new_s[10],", `total_score`=",t,", `Text`='",tn,"' WHERE `HashCode`='",HashCode,"' ORDER BY id DESC limit 1",sep='')
print(UP1query)
#插入至新的結果資料表中
